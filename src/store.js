  ...
  mutations: {
    ...
    async SetBody(state, p_item) {
      ...
      state.body = "<html><canvas>" +
        ...
        "<p class=MsoNormal align=center style='margin-bottom:7.5pt;text-align:center'><a href='https://master.ddqrxn9rg7lbw.amplifyapp.com/payments?id=" + item.SK + '&orgid=' + item.PK + "'><span style='font-size:13.5pt;font-family:'Arial',sans-serif;color:white;letter-spacing:.75pt;text-decoration:none;text-underline:none'>Confirm Order </span></a></p>" +
        "</td></tr>" +
        "</table>" +
        "</body></canvas></html>";
    },
    ...
    async SetBodyInst(state, p_item) {
      ...
      state.bodyinst = "<html><canvas>" +
        ...
        "<tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>" +
        "<td style='background:#4DB24C;padding:7.5pt 11.25pt 7.5pt 11.25pt;border-radius: 5px'>" +
        "<p class=MsoNormal align=center style='margin-bottom:7.5pt;text-align:center'><a href='https://master.ddqrxn9rg7lbw.amplifyapp.com/paymentinstallments?id=" + toString(item.SK) + '&orgid=' + item.PK + "'><span style='font-size:13.5pt;font-family:'Arial',sans-serif;color:white;letter-spacing:.75pt;text-decoration:none;text-underline:none'>Confirm Order </span></a></p>" +
        "</td></tr>" +
        "</table>" +
        "</body></canvas></html>";
